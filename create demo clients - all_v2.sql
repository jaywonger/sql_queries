...
begin
	...
	select @clientID,null,'S'
	from CLTVISITORS
	where CLTVISITOR_ID <> @clientID
	and NOT EXISTS (select exclusionTbl.CLTVISITOR_ID
					from CLTVISITORS exclusionTbl
					where exclusionTbl.CLTVISITOR_ID = @clientID)
	end try
	begin catch
	...
	select @clientID,@lastName,@firstName,@area,@firstName+'.'+@lastName+'@vch.ca','ProcuraAdmin',GETDATE(),GETDATE(),GETDATE(),'ProcuraAdmin','America/Vancouver'
	from CLIENTS
	where CLIENT_ID <> @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLIENTS exclusionTb1
					where exclusionTb1.CLIENT_ID = @clientID)
	end try
	begin catch
	select ERROR_MESSAGE() AS ErrorMessage
	end catch
	...
	select @clientID,@deptID,'A','T',GETDATE(),GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin','F'
	from CLTDEPT
	where CLTVISITOR_ID <> @clientID
	and DEPT_ID <> @deptID
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLTDEPT exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID)
	end try
	begin catch
	select ERROR_MESSAGE() AS ErrorMessage
	end catch
	...
	select @newID,'N0000000010',@clientID,'',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- AGA Support Form
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
					where exclusionTb1.CLIENT_ID = @clientID
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CL_REFNOS(REFNUM_ID,NUMBER_ID,CLIENT_ID,NUMVAL,INTAKE,INTAKEUSER,CHGDATE,CHGUSER)
	select @newID,'N0000000011',@clientID,'',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- Behaviour Care Plan
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CL_REFNOS(REFNUM_ID,NUMBER_ID,CLIENT_ID,NUMVAL,INTAKE,INTAKEUSER,CHGDATE,CHGUSER)
	select @newID,'N0000000019',@clientID,'',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- Consistency
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CL_REFNOS(REFNUM_ID,NUMBER_ID,CLIENT_ID,NUMVAL,INTAKE,INTAKEUSER,CHGDATE,CHGUSER)
	select @newID,'N0000000009',@clientID,'',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- No CPR Form
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CL_REFNOS(REFNUM_ID,NUMBER_ID,CLIENT_ID,NUMVAL,INTAKE,INTAKEUSER,CHGDATE,CHGUSER)
	select @newID,'N0000000012',@clientID,'',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- Notification Expected Death
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CL_REFNOS(REFNUM_ID,NUMBER_ID,CLIENT_ID,NUMVAL,INTAKE,INTAKEUSER,CHGDATE,CHGUSER)
	select @newID,'N0000000003',@clientID,'55555',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- PARIS #
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CL_REFNOS (REFNUM_ID,NUMBER_ID,CLIENT_ID,NUMVAL,INTAKE,INTAKEUSER,CHGDATE,CHGUSER)
	select @newID,'NSH68567599',@clientID,'5555555555',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- PHN #
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CL_REFNOS(REFNUM_ID,NUMBER_ID,CLIENT_ID,NUMVAL,INTAKE,INTAKEUSER,CHGDATE,CHGUSER)
	select @newID,'N0000000007',@clientID,'',GETDATE(),'VCHA_ADMIN',GETDATE(),'VCHA_ADMIN' -- Urgent Response 
	from CL_REFNOS
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CL_REFNOS exclusionTb1
	...
	-- client visit use @clientID and @deptId, figure out RES_ID using if else
	begin try 
	...
	select @clientID, @deptID, 'N0000001058', 'Required', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'N0000001058'
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'N0000001058')


	insert into CLNTRESORC (CLTVISITOR_ID, DEPT_ID, RES_ID, CODE, INTAKE, INTAKEUSER, CHGDATE, CHGUSER)
	select @clientID, @deptID, 'CGH763890023', 'Trained Client Speci', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'CGH763890023'
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'CGH763890023')
	...
	insert into CLNTRESORC (CLTVISITOR_ID, DEPT_ID, RES_ID, CODE, INTAKE, INTAKEUSER, CHGDATE, CHGUSER)
	select @clientID, @deptID, 'T0000000612', 'Trained Client Speci', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'T0000000612'
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'T0000000612')
	...
	insert into CLNTRESORC (CLTVISITOR_ID, DEPT_ID, RES_ID, CODE, INTAKE, INTAKEUSER, CHGDATE, CHGUSER)
	select @clientID, @deptID, 'T0000000774', 'Trained Client Speci', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'T0000000774'
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'T0000000774')
	...
	insert into CLNTRESORC (CLTVISITOR_ID, DEPT_ID, RES_ID, CODE, INTAKE, INTAKEUSER, CHGDATE, CHGUSER)
	select @clientID, @deptID, 'T0000000674', 'Trained Client Speci', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'T0000000674'
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'T0000000674')
	...
	insert into CLNTRESORC (CLTVISITOR_ID, DEPT_ID, RES_ID, CODE, INTAKE, INTAKEUSER, CHGDATE, CHGUSER)
	select @clientID, @deptID, 'N0000001853', 'Trained Client Speci', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'N0000001853'
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'N0000001853')
	...
	insert into CLNTRESORC (CLTVISITOR_ID, DEPT_ID, RES_ID, CODE, INTAKE, INTAKEUSER, CHGDATE, CHGUSER)
	select @clientID, @deptID, 'T0000000055', 'Required', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'T0000000055'
	and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'T0000000055')
	...
	insert into CLNTRESORC (CLTVISITOR_ID, DEPT_ID, RES_ID, CODE, INTAKE, INTAKEUSER, CHGDATE, CHGUSER)
	select @clientID, @deptID, 'T0000000732', 'Required', GETDATE(), 'ProcuraAdmin', GETDATE(), 'ProcuraAdmin'
	from CLNTRESORC
	where CLTVISITOR_ID <> @clientID
	and RES_ID <> 'T0000000732'and NOT EXISTS (select exclusionTb1.CLTVISITOR_ID
					from CLNTRESORC exclusionTb1
					where exclusionTb1.CLTVISITOR_ID = @clientID
					and RES_ID = 'T0000000732')
	...
	**/
	...
	select @newID, 'N0000000269', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Respiratory Screening Question N0000000269
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
					where exclusionTb1.CLIENT_ID = @clientID
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000192', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Bathing Assignable T0000000192
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000196', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Pericare Assignable T0000000196
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000200', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Hair Care Assignable T0000000200
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000202', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Facial Shaving Assignable T0000000202
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000204', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Oral Care A T0000000204
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000209', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Dressing A T0000000209
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000213', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Bladder A T0000000213
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000214', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Bladder D T0000000214
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000223', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Transfers A T0000000223
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000227', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Falls Prevention A T0000000227
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000231', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Meal Setup T0000000231
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000243', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Medication Assist T0000000243
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000247', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Compression Stockings D T0000000247
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000267', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin' -- Garbage & Recycling T0000000267
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
	...
	set @newID = @branchID + right('0000000000' + @nextSyskey, 10)
	insert into CLTACTC(CLTACTC_ID, ACTIVITY_ID, CLIENT_ID, DEPT_ID, CHANGED, FREQTYPE, DAYFREQ, ARCHIVED, INTAKE, INTAKEUSER, CHGDATE, CHGUSER) 
	select @newID, 'T0000000275', @clientID, @deptID, 'F', 'D', 'O', 'F', GETDATE(),'ProcuraAdmin',GETDATE(),'ProcuraAdmin'  -- Respite Blocks T0000000275
	from CLTACTC
	where CLIENT_ID = @clientID
	and NOT EXISTS (select exclusionTb1.CLIENT_ID
					from CLTACTC exclusionTb1
